...
public class EnemyAttack : MonoBehaviour
{
    ...
    public float attackCooldown = 1.5f; //time inbetween attacks
    private float attacktimer;// what actually starts the timer
    private PlayerStats playerHealth;// refrence to the players health 
    private Enemy enemyPatrol;// refrence to the base enemey script

    private void Start()
    {
        playerHealth = player.GetComponent<PlayerStats>();// automaticlly gets the players health script on start
